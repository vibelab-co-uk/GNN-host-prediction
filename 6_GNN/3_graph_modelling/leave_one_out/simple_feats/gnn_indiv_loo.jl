...
# read in cross validation folds - we will use these for the ensemble models
ensemble_folds = CSV.read("../../../../6_GNN/1_generate_validation_sets/cv_folds_5.csv", DataFrame, missingstring = "NA")
