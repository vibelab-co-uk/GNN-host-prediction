...
write_res <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^abl_out*")
  ...
  write_csv(agg_results_full,paste0("aggregate_results_",result_preds$Hidden_layers[1],"_",result_preds$Model_structure[1],"_testonly.csv"))
  write_csv(ROC_results_full,paste0("ROC_PR_results_",result_preds$Hidden_layers[1],"_",result_preds$Model_structure[1],"_testonly.csv"))
  write_csv(noinfo_results_full,paste0("no_info_results_",result_preds$Hidden_layers[1],"_",result_preds$Model_structure[1],"_testonly.csv"))
...
cat_agg <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^aggregate_results_.*_testonly.csv")
...
cat_roc <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^ROC_PR_results_.*_testonly.csv")
...
cat_noinfo <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^no_info_results_.*_testonly.csv")
