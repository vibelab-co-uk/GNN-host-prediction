...
rand1 <- read_csv("paramyxo_rand_features_set1.csv")
rand2 <- read_csv("paramyxo_rand_features_set2.csv")
rand3 <- read_csv("paramyxo_rand_features_set3.csv")
rand4 <- read_csv("paramyxo_rand_features_set4.csv")
rand5 <- read_csv("paramyxo_rand_features_set5.csv")
...
master_list <- list(gc,nt,dint,aac,dp,kmer3,kmer4,kmer5,kmer6,rand1,rand2,rand3,rand4,rand5)
...
setwd("/Users/jamieherzig/Documents/clean_run/6_GNN/patristic_embedding_correlation/dumpout_embeddings/simple_feats/feature_sets")
...
namelist[length(namelist)+1] <- paste0("results_rand1")
namelist[length(namelist)+1] <- paste0("results_rand2")
namelist[length(namelist)+1] <- paste0("results_rand3")
namelist[length(namelist)+1] <- paste0("results_rand4")
namelist[length(namelist)+1] <- paste0("results_rand5")
