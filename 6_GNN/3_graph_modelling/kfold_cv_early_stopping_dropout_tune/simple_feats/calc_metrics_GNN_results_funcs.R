...
write_res <- function(results_dir,dropout){
  ...
  write_csv(agg_results_full,paste0("aggregate_results_",dropout,".csv"))
  write_csv(ROC_results_full,paste0("ROC_PR_results_",dropout,".csv"))
  write_csv(noinfo_results_full,paste0("no_info_results_",dropout,".csv"))
...
cat_agg <- function(results_dir,dropout){
  ...
  agg_results <- read_csv(paste0("aggregate_results_",dropout,".csv"))
...
cat_roc <- function(results_dir,dropout){
  ...
  full_out <- read_csv(paste0("ROC_PR_results_",dropout,".csv"))
...
cat_noinfo <- function(results_dir,dropout){
  ...
  full_out <- read_csv(paste0("no_info_results_",dropout,".csv"))
