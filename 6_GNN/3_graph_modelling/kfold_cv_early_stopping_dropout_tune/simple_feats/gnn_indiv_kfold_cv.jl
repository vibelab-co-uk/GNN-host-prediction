...
for i in dropout_vec
    function feature_comp_train(in_feats,out_dir,nhidden,nlayers)
        ...
        print("Training models with $i dropout")
        ...
        for c in eachcol(cv_folds)
            ...
            ### train models
            abl_out = abl_train(g, out_dir, nhidden = nhidden, nlayers = nlayers, pdropout = i)
        ...
        CSV.write(joinpath(out_dir,"abl_output_dropout_$(i).csv"),cv_out) # write the full ablation prediction results table
    end
