...
function abl_train(g, out_dir; kws...)
    ...
    for epoch in 1:(args.epochs)
        ...
        append!(stop_vec, eval_loss_accuracy(X, y, trues(length(g.labels)), model, g)[1,])
    ...
    # it would also be interesting to see where the predictions sit in the graph - maybe we could flag predictions as correct/incorrect and output a plot of this
