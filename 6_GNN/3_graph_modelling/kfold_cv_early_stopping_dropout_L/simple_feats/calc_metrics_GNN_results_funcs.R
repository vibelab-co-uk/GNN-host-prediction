...
write_res <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^abl_output.*")
...
cat_agg <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^aggregate_results_.*.csv")
...
cat_roc <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^ROC_PR_results_.*.csv")
...
cat_noinfo <- function(results_dir){
  ...
  res_filename <- list.files(pattern="^no_info_results_.*.csv")
