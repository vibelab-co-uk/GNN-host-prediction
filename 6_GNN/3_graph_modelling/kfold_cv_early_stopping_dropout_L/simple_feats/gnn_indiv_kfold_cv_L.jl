...
# edgelist
coo_edgelist = readdlm("../../../../5_phylogeny/3_generate_graph/graph_data/patristic_paraymxo_graph_L.edgelist", Int64)
...
# edge weights
edge_weights = CSV.File("../../../../5_phylogeny/3_generate_graph/graph_data/patristic_paramyxo_graph_branch_weights_L.csv") |> DataFrame

# node metadata
node_names = CSV.File("../../../../5_phylogeny/3_generate_graph/graph_data/patristic_paramyxo_graph_node_names_L.csv") |> DataFrame
...
function feature_comp_train(in_feats,out_dir,nhidden,nlayers)
    ...
    CSV.write(joinpath(out_dir,"abl_output_$(nhidden)_$(nlayers).csv"),cv_out) # write the full ablation prediction results table
end
