...
nhidden = c(128,256,512,1024)
nlayers = c(2,3,4)

# read in tbl containing subgraph membership information
subgraph_membership <- read_xlsx("../../../../5_phylogeny/3_generate_graph/subgraph_membership_final_UTR.xlsx")

# analyse results ---------------------------------------------------------
dirlist <- paste0("./feature_sets/",list.files(path = "./feature_sets",pattern="^results_both*"))
...
write_xlsx(subgraph_agg, paste0("subgraph_agg_performance_all_params_both.xlsx"))
write_xlsx(subgraph_roc, paste0("subgraph_roc_performance_all_params_both.xlsx"))
write_xlsx(subgraph_noinfo, paste0("subgraph_noinfo_performance_all_params_both.xlsx"))

write_xlsx(all_agg, paste0("agg_performance_full_all_params_both.xlsx"))
write_xlsx(all_roc, paste0("roc_performance_full_all_params_both.xlsx"))
write_xlsx(all_noinfo, paste0("noinfo_performance_full_all_params_both.xlsx"))
