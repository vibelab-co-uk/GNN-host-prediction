...
write_res <- function(results_dir,nhidden,nlayers){
  ...
  result_preds <- read_csv(paste0("nn_output_",nhidden,"_",nlayers,".csv"))
...
cat_agg <- function(results_dir,nhidden,nlayers){
  ...
  agg_results <- read_csv(paste0("aggregate_results_",nhidden,"_",nlayers,"denselayers.csv"))
...
cat_roc <- function(results_dir,nhidden,nlayers){
  ...
  full_out <- read_csv(paste0("ROC_PR_results_",nhidden,"_",nlayers,"denselayers.csv"))
...
cat_noinfo <- function(results_dir,nhidden,nlayers){
  ...
  full_out <- read_csv(paste0("no_info_results_",nhidden,"_",nlayers,"denselayers.csv"))
