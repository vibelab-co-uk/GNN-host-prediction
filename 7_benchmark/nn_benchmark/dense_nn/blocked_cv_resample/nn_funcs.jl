...
function nn_train(features, truth, out_dir, mask, accessions; kws...)
    args = Args(; kws...)
    ...
    function report(epoch)
        ...
        open(joinpath(out_dir,"training_log_$(args.nhidden).txt"),"a") do io
    ...
    for epoch in 1:(args.epochs)
        ...
        # append current model loss to the stopping vector
