...
ambig_fasta <- readDNAStringSet("../../1_nucleotide_processing/1_initial_cleaning/11158_paramyxoviridae_cleaned_nucseqs_21112025.fasta")
...
# x <- ambig_seqs[10]
# 
# test <- lapply(ambig_seqs,resolve_ambig)
...
writeXStringSet(all_orfs,"../../4_feature_generation/1_ambiguous_codon_assignment/all_orfs_ambig_corrected.fasta")
