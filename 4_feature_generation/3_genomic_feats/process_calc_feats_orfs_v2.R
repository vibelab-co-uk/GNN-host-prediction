...
write_csv(output,"./nucleotide_feats/paramyxo_gc_prop_features.csv")
...
for(i in 1:5){
  ...
  write_csv(rand_set,paste0("./nucleotide_feats/paramyxo_rand_features_set",i,".csv"))
}
...
write_csv(output,"./nucleotide_feats/paramyxo_nt_prop_features.csv")
...
write_csv(output,"./nucleotide_feats/paramyxo_dint_prop_features.csv")
...
write_csv(output,"./nucleotide_feats/paramyxo_3mer_prop_features.csv")
...
write_csv(output,"./nucleotide_feats/paramyxo_4mer_prop_features.csv")
...
write_csv(output,"./nucleotide_feats/paramyxo_5mer_prop_features.csv")
...
write_csv(output,"./nucleotide_feats/paramyxo_6mer_prop_features.csv")
